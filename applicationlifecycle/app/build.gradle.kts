...
android {
  namespace = "horizon.platform.sample.applicationlifecycle"
  compileSdk { version = release(36) { minorApiLevel = 1 } }

  defaultConfig {
    applicationId = "horizon.platform.sample.applicationlifecycle"
    minSdk = 34
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
...
dependencies {
  ...
  implementation(libs.psdk.application.lifecycle)
